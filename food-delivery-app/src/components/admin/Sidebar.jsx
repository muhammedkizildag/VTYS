...
import { LayoutDashboard, Utensils, ShoppingBag, Settings, LogOut, Store } from 'lucide-react';

// Sidebar, parent layout'tan 'restaurantId' prop'unu alacak
export default function Sidebar({ restaurantId }) {
  
  // Basit aktif link kontrolü (Preview için)
  const isActive = (path) => {
